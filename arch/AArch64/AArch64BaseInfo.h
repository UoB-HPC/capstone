...
typedef enum AArch64CC_CondCode { // Meaning (integer)     Meaning
				  // (floating-point)
...
AArch64VectorLayoutToString(A64Layout_VectorLayout Layout)
{
  ...
  default:
    return NULL; // never reach
  case A64Layout_VL_8B:
    return ".8b";
  case A64Layout_VL_4H:
    return ".4h";
  case A64Layout_VL_2S:
    return ".2s";
  case A64Layout_VL_1D:
    return ".1d";
  case A64Layout_VL_16B:
    return ".16b";
  case A64Layout_VL_8H:
    return ".8h";
  case A64Layout_VL_4S:
    return ".4s";
  case A64Layout_VL_2D:
    return ".2d";
  case A64Layout_VL_B:
    return ".b";
  case A64Layout_VL_H:
